...
public final class TristateCheckBox extends JCheckBox {
	...
	private static final long serialVersionUID = 5651958402263088686L;
	...
	public TristateCheckBox(String text, Icon icon,
		...
		actions.put("pressed", new AbstractAction() {
			private static final long serialVersionUID = 145945883309319589L;
	...
	public void setState(Boolean b){
		if(b == null)
			...
			getTristateModel().setSelected(true);
		else // if(b.equals(Boolean.FALSE))
			getTristateModel().setSelected(false);
//		else
//			getTristateModel().setIndeterminate();
	}
}
